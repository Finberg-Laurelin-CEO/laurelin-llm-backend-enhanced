...
<body>
    ...
    <script>
        const API_BASE = 'https://us-central1-sacred-attic-473120-i0.cloudfunctions.net';
        ...
        async function testHealthCheck() {
            try {
                const response = await fetch(\`\${API_BASE}/llm-health-check\`);
        ...
        async function testLoginAPI() {
            try {
                const response = await fetch(\`\${API_BASE}/llm-login-api\`, {
                    method: 'POST',
                    headers: {
